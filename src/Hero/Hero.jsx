...
const Hero = ({ loading }) => {
  ...
  const backgrounds = ["https://tagmango.com/staticassets/1642224576818.jpg"];
  ...
  //           } else {
  //             current.classList.remove("active");
  //             document.querySelector(".hero--carousal").firstElementChild.classList.add("active");
  //           }
    ...
    <div
      ...
      <div className="hero--wrapper">
        <div className="hero__logo">
          <svg xmlns="http://www.w3.org/2000/svg" width="130.049" height="27.115" viewBox="0 0 130.049 27.115">
        ...
        <div className="hero--content">
          <h1>TagMango Residency Programme</h1>
          <p>2 week-cohorts for Leaders, Thinkers and Creators to meet, ideate and build together.</p>
          <a href="https://forms.gle/BxgWgdRKgrZCtWSJ7" target="_blank" className="apply_now_button">
            Apply Now
          </a>
          <div className="hero--carousal">
            {/* <div className={`hero--carousal__bar ${loading ? "" : "active"}`}></div>
